...
{
    [Serializable]
    public class HumanRotationYawFK : THumanRotations
    {
        // EXPOSED METHODS: -----------------------------------------------------------------------
        ...
        [SerializeField] private PropertyGetDecimal m_Arms = GetDecimalDecimal.Create(0.1f);
        [SerializeField] private PropertyGetDecimal m_Hands = GetDecimalDecimal.Create(0.05f);
