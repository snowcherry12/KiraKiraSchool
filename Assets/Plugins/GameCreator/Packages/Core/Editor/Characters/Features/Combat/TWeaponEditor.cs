...
namespace GameCreator.Editor.Characters
{
    public abstract class TWeaponEditor : UnityEditor.Editor
    {
        ...
        protected abstract bool HasParriedReaction { get; }
        protected abstract bool HasDodge { get; }
        
        protected abstract void CreateGUI(VisualElement root);

        protected virtual void CreateInHead(VisualElement head)
        { }
        
        protected virtual void CreateInFoot(VisualElement foot)
        { }
    }
}