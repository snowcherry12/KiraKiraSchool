...
namespace GameCreator.Runtime.Characters
{
    ...
    public abstract class TUnitFacing : TUnit, IUnitFacing
    {
        ...
        [NonSerialized] protected Vector3 m_FaceDirection;

        [NonSerialized] protected float m_PivotSpeed;
        
        [NonSerialized] private Quaternion m_RotationVelocity = Quaternion.identity;

        [NonSerialized] private Dictionary<int, FacingLayer> m_LayersData;
        [NonSerialized] private List<int> m_LayersQueue;
        ...
        public virtual void OnUpdate()
        {
            ...
            Quaternion rotation = this.Character.Motion.AngularSpeed >= 0f
                ? QuaternionUtils.SmoothDamp(
