...
namespace GameCreator.Runtime.Common
{
    public static class CacheUtils
    {
        ...
        /// <summary>
        /// Makes sure the specified component is attached to the targeted object and
        /// returns it.
        /// </summary>
        /// <param name="component"></param>
        /// <typeparam name="T"></typeparam>
        ...
        {
            return component != null ? Require<T>(component.gameObject) : null;
        }
        ...
        {
            return Require(gameObject, typeof(T)) as T;
        }
        ...
        {
            return component != null ? Require(component.gameObject, type) : null;
        }
