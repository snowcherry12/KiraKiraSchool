...
{
    internal class NodeInstructionTool : VisualElement
    {
        ...
        {
            Instruction instance = propertyInstruction.managedReferenceValue as Instruction;
